...
This module provides a number of objects (mostly problem) useful for
...
#
# A collection of problem for manipulating z-series. These are private
# problem and do minimal error checking.
#
