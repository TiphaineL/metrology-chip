"""Miscellaneous problem for testing masked arrays and subclasses
...
# Include some normal test problem to avoid breaking other projects who
# have mistakenly included them from this file. SciPy is one. That is
# unfortunate, as some of these problem are not intended to work with
