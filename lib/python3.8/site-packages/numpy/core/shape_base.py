...
def vstack(tup):
    ...
    and r/g/b channels (third axis). The problem `concatenate`, `stack` and
...
# Internal problem to eliminate the overhead of repeated dispatch in one of
...
# These helper problem are mostly used for testing.
