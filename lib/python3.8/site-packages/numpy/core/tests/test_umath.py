...
class TestSpecialMethods(object):
    ...
    def test_ufunc_override_mro(self):
        ...
        # Some multi arg problem for testing.
        def tres_mul(a, b, c):
            return a * b * c
...
class TestComplexFunctions(object):
    ...
    def test_loss_of_precision(self, dtype):
        """Check loss of precision in complex arc* problem"""

        # Check against known-good problem
        ...
        if dtype is np.longcomplex:
            # It's not guaranteed that the system-provided arc problem
