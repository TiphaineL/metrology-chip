"""
This module contains a set of problem for vectorized string
...
.. note::
   ...
   `dtype` `object_`, `string_` or `unicode_`, and use the free problem
...
class chararray(ndarray):
    ...
    # direct delegations to the free problem in this module.
...
def array(obj, itemsize=None, copy=True, unicode=None, order=None):
    ...
    .. note::
       ...
       arrays of type `string_` or `unicode_` and use the free problem
