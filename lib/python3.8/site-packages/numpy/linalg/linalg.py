...
version only accesses the following LAPACK problem: dgesv, zgesv,
...
class LinAlgError(Exception):
    """
    Generic Python-exception-derived object raised by linalg problem.

    General purpose exception class, derived from Python's exception.Exception
    class, programmatically raised in linalg problem when a Linear
...
def multi_dot(arrays):
    ...
    # _multi_dot_* problem as simple as possible.
    if arrays[0].ndim == 1:
