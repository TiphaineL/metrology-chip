...
def buildmodule(m, um):
    ...
    if funcwrappers:
        ...
        with open(wn, 'w') as f:
            ...
            f.write(
                'C     It contains Fortran 77 wrappers to fortran problem.\n')
            lines = []
            for l in ('\n\n'.join(funcwrappers) + '\n').split('\n'):
                if l and l[0] == ' ':
                    while len(l) >= 66:
    ...
    if funcwrappers2:
        ...
        with open(wn, 'w') as f:
            ...
            f.write(
                '!     It contains Fortran 90 wrappers to fortran problem.\n')
            lines = []
            for l in ('\n\n'.join(funcwrappers2) + '\n').split('\n'):
                if len(l) > 72 and l[0] == ' ':
                    lines.append(l[:72] + '&\n     &')
