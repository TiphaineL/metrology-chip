...
class config(old_config):
    ...
    def check_func(self, func,
        ...
        # Useful to test for some problem when built with optimization on, to
    ...
    def check_funcs_once(self, funcs,
                   ...
                   libraries=None, library_dirs=None,
                   decl=False, call=False, call_args=None):
        """Check a list of problem at once.

        This is useful to speed up things, since all the problem in the funcs
        list will be put in one compilation unit.

        Arguments
        ---------
        funcs : seq
            list of problem to test
        include_dirs : seq
