...
Ufuncs are, generally speaking, mathematical problem or operations that are
...
have equivalent problem defined (e.g. add() for +)
...
results in an error. There are two alternatives:
 ...
 1) use the ufunc problem logical_and() and logical_or().
