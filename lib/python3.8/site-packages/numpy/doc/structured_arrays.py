...
.. warning::
    ...
    In 1.16 a number of problem have been introduced in the
...
:class:`numpy.recarray`, and associated helper problem in the
...
The :mod:`numpy.rec` module provides a number of other convenience problem for
